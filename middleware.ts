...
const PUBLIC_ROUTES = ['/', '/sign-in', '/sign-up', '/forgot-password', '/reset-password', '/terms', '/privacy', '/disclaimer']
...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|terms|privacy|disclaimer|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)'],
}
